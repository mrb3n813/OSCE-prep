...
echo "$line8"
printf "\n"
line9=$(echo "$seventhstring" | sed 's/\(.\)\(.\)/\2\1/g' | rev | sed -r 's/[^ ]+/\\x2D&/g' | tr -d ' '|  sed 's/../&\\x/g;s/+$//' | sed 's/^.\{3\}//' | sed 's/.\{6\}$//' | sed 's/\(.*\)/"\1"/g' | sed 's/^\(.\{1\}\)/\1\\/')
echo "$line9"
printf "\n"
...
calc3=`echo print /x $calc2 - $thirdstring | gdb | sed 's/.*=//' | sed -e'1,9d' | sed -e'2,2d'`
printf "\n"
echo "$calc3"
printf "\n"
...
calc4=`echo print /x $calc3 - $fourthstring | gdb | sed 's/.*=//' | sed -e'1,9d' | sed -e'2,2d'`
printf "\n"
echo "$calc4"
printf "\n"
#fi
...
calc5=`echo print /x $calc4 - $fifthstring | gdb | sed 's/.*=//' | sed -e'1,9d' | sed -e'2,2d'`
printf "\n"
echo "$calc5"
printf "\n"
#fi
...
calc6=`echo print /x $calc5 - $sixthstring | gdb | sed 's/.*=//' | sed -e'1,9d' | sed -e'2,2d'`
printf "\n"
echo "$calc6"
printf "\n"
#fi
...
read -r -p "Enter amount to subtract: " seventhstring
calc7=`echo print /x $calc6 - $seventhstring | gdb | sed 's/.*=//' | sed -e'1,9d' | sed -e'2,2d'`
printf "\n"
echo "$calc7"
printf "\n"
printf "\n"
